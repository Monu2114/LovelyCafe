    ...
    items: [
      {
        ...
        price: "$6.50",
        description: "Infused with organic rose water",
        image:
          "https://images.unsplash.com/photo-1550951177-3e6f980145cf?q=80&w=2574&auto=format&fit=crop",
      },
      {
        name: "Smoked Vanilla Cold Brew",
        price: "$5.50",
        description: "Oak-smoked vanilla bean syrup",
        image:
          "https://images.unsplash.com/photo-1517701604599-bb29b5c7dd90?q=80&w=2670&auto=format&fit=crop",
      },
      {
        name: "Vintage Chocolate Shake",
        price: "$8.00",
        description: "70% Dark chocolate, sea salt",
        image:
    ...
    items: [
      {
        ...
        image:
          "https://images.unsplash.com/photo-1555507036-ab1f40388085?q=80&w=2526&auto=format&fit=crop",
      },
      {
        name: "Lemon Lavender Cake",
        price: "$5.00",
        description: "Zesty lemon curd glaze",
        image:
          "https://images.unsplash.com/photo-1627308595229-7830a5c91f9f?q=80&w=2574&auto=format&fit=crop",
      },
    ],
  },
  {
    ...
    items: [
      {
        name: "Modern Romance",
        price: "Various",
        description: "Curated contemporary love stories",
        image:
      ...
      },
      {
        name: "Classic Poetry",
        price: "Various",
        description: "Keats, Yeats, and Plath",
        image:
          "https://images.unsplash.com/photo-1544947950-fa07a98d237f?q=80&w=2573&auto=format&fit=crop",
      },
    ],
  },
];
  ...
  return (
    <section className="min-h-screen py-32 px-4 md:px-20 bg-[#F8F5EF] flex flex-col md:flex-row gap-12">
      <div className="md:w-1/2">
        <h2 className="text-4xl md:text-6xl font-serif text-[#3A2F2F] mb-12">
          Table & Shelf
        </h2>
          ...
          {menuData.map((category) => (
            <div key={category.id} className="border-b border-[#D9D6D2] pb-8">
              <button
                ...
                className={`text-2xl font-serif mb-6 transition-colors duration-300 w-full text-left flex justify-between items-center ${
                      ...
                      {category.items.map((item, idx) => (
                        ...
                        >
                          <div className="flex justify-between items-baseline mb-1">
                            ...
                            <span className="font-sans text-sm text-[#7C8B6A]">
                              {item.price}
                            </span>
                          </div>
        ...
        <div className="sticky top-32 w-full aspect-[4/5] bg-[#EDE7DB] rounded-sm overflow-hidden p-4">
          <AnimatePresence mode="wait">
            <motion.img
              ...
              src={
                hoveredImage ||
                menuData.find((c) => c.id === activeCategory)?.items[0].image
              }
